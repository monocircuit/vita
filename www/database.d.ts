...
export interface Database {
  ...
  public: {
    Tables: {
      ...
      chronicles: {
        Row: {
          category: Database["public"]["Enums"]["chronicle_category"];
        ...
        Relationships: [
          {
            foreignKeyName: "chronicles_entity_id_fkey";
            columns: ["entity_id"];
            isOneToOne: false;
      ...
      vitas_shards_dynamic: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "vitas_shards_dynamic_next_id_next_id_fkey";
            columns: ["next_id", "next_id"];
            isOneToOne: false;
            referencedRelation: "vitas_shards_dynamic";
            referencedColumns: ["id", "vita_id"];
          },
          {
            foreignKeyName: "vitas_shards_dynamic_prev_id_prev_id_fkey";
            columns: ["prev_id", "prev_id"];
            isOneToOne: false;
            referencedRelation: "vitas_shards_dynamic";
            referencedColumns: ["id", "vita_id"];
          },
